...
class BaseConvertor:
    ...
    Args:
        dict_type (str): Type of dict, should be either 'DICT36' or 'DICT90' or 'DICTTBRAIN'.
    ...
    DICT90 = tuple('0123456789abcdefghijklmnopqrstuvwxyz'
                   ...
                   '*+,-./:;<=>?@[\\]_`~')
    DICTTBRAIN = tuple('0123456789'
                   'ABCDEFGHIJKLMNPQRSTUVWXYZ')

    def __init__(self, dict_type='DICT90', dict_file=None, dict_list=None):
        assert dict_type in ('DICT36', 'DICT90', 'DICTTBRAIN')
        ...
        if dict_file is not None:
            ...
            elif dict_type == 'DICTTBRAIN':
                self.idx2char = list(self.DICTTBRAIN)
            else:
